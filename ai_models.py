    ...
    def query_chatgpt(self, problem_text):
        ...
        try:
            ...
            response = self.openai_client.chat.completions.create(
                ...
                messages=[
                    {"role": "system", "content": "You are a math expert. Your task is to solve math problems step-by-step, show all work, and clearly state the final answer. Do not include any introductory text. Go straight to solving the problem."},
    ...
    def query_deepseek(self, problem_text):
        ...
        try:
            ...
            payload = {
                "model": "deepseek-chat", 
                "messages": [
                    {"role": "system", "content": "You are a math expert. Your task is to solve math problems step-by-step, show all work, and clearly state the final answer. Do not ask for clarification."},
                    {"role": "user", "content": formatted_problem}
                ],
                "temperature": 0.1,
                "max_tokens": 2000
            ...
            if response.status_code == 200:
                ...
                if "choices" in response_json and len(response_json["choices"]) > 0:
                    ...
                    return f"Error: Unexpected response format: {response.text[:100]}..."
            else:
